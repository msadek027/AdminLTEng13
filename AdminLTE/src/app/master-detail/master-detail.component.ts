...
selectedMonth = this.monthList[0];
  ...
  columnDefs: ColDef[] = [
    ...
    {headerName: 'QuickSearch',field: 'QuickSearch',sortable: true, hide:true, filter: true , editable: false,
  ...
  getQuickFilterText: function (params) {
    ...
    {headerName: 'Rate/price',field: 'price', sortable: true, filter: true,editable: true},
     ...
     {
      headerName: 'Dynamic Styles',field: 'dynamic',
      cellStyle: params => {
  ...
  {
    headerName: 'Actions',field: 'ACTION',sortable: true,filter: true,resizable: true,
    cellRenderer: function (params:any) {
...
columnDefsPopup: ColDef[] = [
 ...
 onGridReadyPopup(eParams:any) {
  this.agGridPopup.api =eParams.api;
  eParams.api.sizeColumnsToFit();
}
btnExport() {
  debugger;
...
rowData = [
   {chk:'', make: 'Toyota', model: 'Celica', price: 35000, dynamic: 'Police' ,QuickSearch:'Hidden'}, 
   {chk:'', make: 'Acust', model: 'bb', price: 35000, dynamic: 'vip' ,QuickSearch:'Hidden'},
   {chk:'', make: 'Porschea', model: 'Boxter', price: 72000,dynamic: 'public' ,QuickSearch:'Hidden'},
   {chk:'', make: 'Ford', model: 'Mondeo', price: 32000, dynamic: 'Police',QuickSearch:'Hidden'},  
   {chk:'', make: 'Toyota', model: 'Celica', price: 35000, dynamic: 'Police',QuickSearch:'Hidden' }, 
...
{  
 ...
 // alert('Grid row click cell event:' + selectedRows2.make+', '+ selectedRows2.model+', '+ selectedRows2.price);
  ...
  if (params.colDef.field === 'make') 
  {
   ...
   let  rowTemp = { chk:'', make: 'Default(F9)', model: 'Runner', price: 10000, dynamic: '' ,QuickSearch:'Hidden' }; 
...
if(isAddRow===0)
{
  ...
  saveItems()
  {
   ...
   var dataList = [];  
   var model: iMasterItem = { SetDate: this.SetDate,Year: this.Year,MonthNumber: this.Year,Remarks:this.Remarks, detailList:[]};
  ...
  viewItems()
  {
   ...
   /*
     this.service.getMasterDetailObjectArray2().subscribe(data=>{ 
      for (const d of (data as any)) {
        this.Remarks=d.Remarks;   
        dataList.push({make: d.make,model: d.model});
      }
     this.rowData=dataList;
      console.log(dataList);
    });
*/
this.service.getMasterDetailObject().subscribe(results => {
  this.data2=results;
  var res:any =JSON.stringify(results);
  console.log(res);
  this.Remarks=res.Remarks; 
  this.rowData=res.detailList; 
  
console.log("Log: "+this.Remarks);
     ...
     // let obj: iMasterItem = JSON.parse('{ "SetDate": "", "Year": 4 }');
